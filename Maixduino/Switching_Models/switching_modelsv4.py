    ...
    while(True):
        ...
        if faces:
            ...
            for face in faces:
                ...
                #b = img.draw_rectangle(obj.rect(),color=(0,255,0),thickness=3) #draw the rectangle
            ...
            #range_areas = range(len(faces_areas))
            #print(faces_areas[1])
            #if range_areas == 1:
                #print('so tem uma face!')
                ##largest_face_area=faces_areas[1]
                ##id_area = 0
            #else:
            ...
            #for i in range(faces_areas):
            #if faces_areas[i] >= largest_face_area and face:
            ...
            #map function, or linear linearization of the inver_px value to the angle scale to get the angle of the servo:
            face_angle = (face_invert_px - in_min) * (out_max - out_min) / (in_max - in_min) + out_min
            print('angulo: ')
            print(face_angle)

            #apply the x angle to the servo
            Servo(S1, int(face_angle))
