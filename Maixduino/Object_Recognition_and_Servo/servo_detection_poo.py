...
class Object_Recognition():
        ...
        def Servo(self,servo,angle):
            self.S1.duty((angle+90)/180*10+2.5)
            ...
            # if objects are detected on camera by yolo:
                if objects:
                    ...
                    for obj in objects:
                        ...
                        img.draw_string(obj.x(), obj.y(), self.classes[obj.classid()], color=(0,255,0),scale=2) #write the name of the object
                        img.draw_string(obj.x(), obj.y()+12, '%.3f'%obj.value(), color=(0,255,0),scale=2) #confidence value
                        var = self.classes[obj.classid()]  #get the name of the object
        ...
        #lcd.display(img)
            ...
            kpu.deinit(self.task) #necessary?
